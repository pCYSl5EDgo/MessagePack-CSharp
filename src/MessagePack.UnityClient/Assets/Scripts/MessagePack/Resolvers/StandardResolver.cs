...
namespace MessagePack.Resolvers
{
    ...
    public sealed class ContractlessStandardResolverAllowPrivateForceTrackReference : IFormatterResolver
    {
        /// <summary>
        /// The singleton instance that can be used.
        /// </summary>
        public static readonly ContractlessStandardResolverAllowPrivateForceTrackReference Instance;
...
#if !ENABLE_IL2CPP && !NET_STANDARD_2_0
            DynamicObjectResolverAllowPrivate.Instance, // Try Object
            DynamicContractlessObjectResolverAllowPrivateForceTrackReference.Instance, // Serializes keys as strings
#endif
        }).ToArray();

        static ContractlessStandardResolverAllowPrivateForceTrackReference()
        {
            Instance = new ContractlessStandardResolverAllowPrivateForceTrackReference();
            Options = new MessagePackSerializerOptions(Instance);
        }

        private ContractlessStandardResolverAllowPrivateForceTrackReference()
        {
        }
