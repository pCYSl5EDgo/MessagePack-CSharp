...
namespace MessagePack.Resolvers
{
    ...
    /// Preserves .NET <see cref="DateTime"/> timezone.
    /// </summary>
    public sealed class TypelessCircularContractlessStandardResolver : IFormatterResolver
    {
        /// <summary>
        /// The singleton instance that can be used.
        /// </summary>
        public static readonly TypelessCircularContractlessStandardResolver Instance;
        ...
        private static readonly IReadOnlyList<IFormatterResolver> Resolvers = new IFormatterResolver[]
        {
            ...
            TypelessCircularObjectResolver.Instance,
        };

        static TypelessCircularContractlessStandardResolver()
        {
            Instance = new TypelessCircularContractlessStandardResolver();
            Options = new MessagePackSerializerOptions(Instance);
        }
